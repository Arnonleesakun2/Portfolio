          ...
          {project.map((item, index) => {
            return (
              <MotionItem key={index}>
                <div className="border border-white/20 backdrop-blur-2xl hover:border-gray-300 transition-all duration-500 hover:shadow-lg hover:shadow-gray-300 rounded-4xl shadow-2xl">
                  <div className="p-6">
                    <div className="lg:grid lg:grid-cols-6 gap-6">
                      ...
                      <div className="space-y-4 col-span-4">
                        ...
                        <div className="space-y-2">
                          <h4 className="text-sm uppercase tracking-wider text-amber-400 font-semibold">
                            Technologies
                          </h4>
